...
if(childData.atendido==1){
            ...
            cellMotorista.appendChild(document.createTextNode(childData.veiculolitros));
        ...
        document.getElementById("inf").innerHTML=`<h6>SOLICITAÇÕES ATENDIDAS:&nbsp ${rowIndex-1}</h6>`;
    });
